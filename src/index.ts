...
import { CacheClient, CacheDelete, CacheFlush, CacheGet, CacheItemGetTtl, CacheSet } from "@gomomento/sdk";
...
class KeyvMomento<Value = any> extends EventEmitter implements Store<Value> {
  ...
  constructor(client: CacheClient, cacheName: string, options?: KeyvMomentoOptions<Value>) {
    super();
